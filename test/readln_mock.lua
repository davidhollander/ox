...
setchunks {'\r\n\r\n'}
local c = {}
readln(c, 2048, function(line) i=i+1 assert(line=='') end)
readln(c, 2048, function(line) i=i+1 assert(line=='') end)
...
setchunks {'hello\r\nworld\r\n'}
local c = {}
readln(c, 2048, function(line) i=i+1 assert(line=='hello') end)
readln(c, 2048, function(line) i=i+1 assert(line=='world') end)
...
for i=1,128 do
  ...
  for j,l in ipairs(lines) do
    readln(c, 2048, function(line) k=k+1 assert(line==l,'err: '..line..' '..l) end)
  end
end
